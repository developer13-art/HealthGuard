...
import { Home, User, Shield, FileText, Heart, Users, Stethoscope, Building2, Ambulance, Building, UserCog, QrCode, Activity, FileCheck, Settings, ClipboardList, MessageSquare, DollarSign, } from "lucide-react";
      ...
      <SidebarHeader className="border-b p-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            {uid && (<span className="text-xs text-muted-foreground font-mono" data-testid="text-sidebar-uid">
                {uid.slice(0, 12)}...
              </span>)}
          </div>
        </div>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            ...
            return (<SidebarMenuItem key={item.title}>
                    <SidebarMenuButton onClick={() => setLocation(item.url)} isActive={isActive} data-testid={`link-${item.title.toLowerCase().replace(/\s+/g, '-')}`}>
