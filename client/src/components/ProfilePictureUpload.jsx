...
export default function ProfilePictureUpload() {
    ...
    const uploadMutation = useMutation({
        mutationFn: (profilePicture) => apiRequest("POST", "/api/user/profile-picture", { profilePicture }),
        onSuccess: () => {
            toast({
    ...
    return (<Card>
      ...
      <CardContent className="flex flex-col items-center space-y-4">
        ...
        <input ref={fileInputRef} type="file" accept="image/*" onChange={handleFileSelect} className="hidden" data-testid="input-profile-picture"/>
        
        <Button onClick={() => fileInputRef.current?.click()} disabled={uploadMutation.isPending} data-testid="button-upload-picture">
