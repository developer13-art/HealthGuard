...
import { User, Wallet, Calendar, Shield, Phone, Mail, MapPin, Activity, Heart, Users, FileText, Clock } from "lucide-react";
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden" data-testid="dialog-user-details">
        ...
        <ScrollArea className="h-[calc(90vh-120px)] pr-4">
          <div className="space-y-6">
            ...
            {kyc && (<Card>
                ...
                <CardContent className="space-y-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {kyc.institutionName && (<InfoRow icon={Users} label="Institution Name" value={kyc.institutionName}/>)}
            ...
            {healthProfile && (<Card>
                ...
                <CardContent className="space-y-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {healthProfile.allergies && healthProfile.allergies.length > 0 && (<div className="flex items-start gap-3 py-2 col-span-2">
                    ...
                    {healthProfile.chronicConditions && healthProfile.chronicConditions.length > 0 && (<div className="flex items-start gap-3 py-2 col-span-2">
                        <Heart className="h-4 w-4 text-muted-foreground mt-0.5"/>
                        <div className="flex-1 space-y-1">
            ...
            {auditLogs && auditLogs.length > 0 && (<Card>
                <CardHeader>
                  <CardTitle className="text-sm font-medium flex items-center gap-2">
                ...
                <CardContent>
                  <ScrollArea className="h-64">
                    <div className="space-y-3">
                      {auditLogs.slice(0, 20).map((log) => (<div key={log.id} className="flex items-start gap-3 border-l-2 border-muted pl-3 py-2" data-testid={`log-${log.id}`}>
                          ...
                          <div className="flex-1 space-y-1">
                            ...
                            {log.targetType && (<p className="text-xs text-muted-foreground">
