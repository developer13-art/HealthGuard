      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (<div className="flex justify-center py-8">
            ...
            </div>) : !claims || claims.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
              ...
              <TableBody>
                {claims.map((claim) => (<TableRow key={claim.id} data-testid={`row-claim-${claim.id}`}>
                    ...
                    <TableCell>
                      <Badge variant={claim.status === "paid" ? "default" :
                    claim.status === "approved" ? "default" :
                        claim.status === "rejected" ? "destructive" :
                            "secondary"} data-testid="badge-claim-status">
                        {claim.status}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <Button variant="outline" size="sm" onClick={() => handleViewDetails(claim)} data-testid={`button-view-details-${claim.id}`}>
      ...
      <Dialog open={detailDialogOpen} onOpenChange={setDetailDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          {selectedClaim && (<div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge variant={selectedClaim.status === "paid" ? "default" :
              ...
              {/* Treatment Details */}
              {selectedClaim.treatmentDescription && (<div className="space-y-3">
                  <h3 className="font-semibold flex items-center gap-2">
              ...
              {/* Patient Note */}
              {selectedClaim.patientNote && (<div className="space-y-3">
              ...
              {/* Rejection Reason */}
              {selectedClaim.rejectionReason && (<div className="space-y-3">
