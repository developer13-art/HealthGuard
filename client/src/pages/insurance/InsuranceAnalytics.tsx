    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-total-payout">SOL {(analytics?.totalPayout || 0).toLocaleString()}</div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">SOL {(claimTypeData.emergency || 0).toLocaleString()}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Outpatient Services</span>
                <span className="text-sm font-medium">SOL {(claimTypeData.outpatient || 0).toLocaleString()}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Inpatient Services</span>
                <span className="text-sm font-medium">SOL {(claimTypeData.inpatient || 0).toLocaleString()}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm">Surgery</span>
                <span className="text-sm font-medium">SOL {(claimTypeData.surgery || 0).toLocaleString()}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">SOL {(analytics?.totalPayout || 0).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Average Claim:</span>
                <span className="font-medium">
                  SOL {analytics?.claimsThisMonth > 0 ? Math.round(analytics.totalPayout / analytics.claimsThisMonth).toLocaleString() : 0}
                </span>
              </div>
            </div>
          </CardContent>
